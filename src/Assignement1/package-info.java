 ...
 * 
	...
	7. Write a program to print the sum of the first 20 natural numbers. 8. Write a program to reverse the elements of an array where the array size as well as the array values are entered by the user. 
